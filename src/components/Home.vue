                  ...
                  <div class="tm-product-card-info">
                    ...
                    <h3 class="tm-product-card-title">
                      <a class="uk-link-heading"
                        >Apple MacBook 12&quot; MNYN2LL/A 512GB (Rose Gold)</a
                      >
                    </h3>
                    <ul
                      class="uk-list uk-text-small tm-product-card-properties"
              ...
              <article class="tm-product-card">
                ...
                <div class="tm-product-card-body">
                  <div class="tm-product-card-info">
                    ...
                    <h3 class="tm-product-card-title">
                      <a class="uk-link-heading"
                        >Lenovo IdeaPad YOGA 920-13IKB 80Y7001RRK (Copper)</a
                      >
                    </h3>
                    <ul
                      class="uk-list uk-text-small tm-product-card-properties"
              ...
              <article class="tm-product-card">
                ...
                <div class="tm-product-card-body">
                  <div class="tm-product-card-info">
                    ...
                    <h3 class="tm-product-card-title">
                      <a class="uk-link-heading"
                        >ASUS Zenbook UX330UA-FC020T (Rose Gold)</a
                      >
                    </h3>
                    <ul
                      class="uk-list uk-text-small tm-product-card-properties"
              ...
              <article class="tm-product-card">
                ...
                <div class="tm-product-card-body">
                  <div class="tm-product-card-info">
                    ...
                    <h3 class="tm-product-card-title">
                      <a class="uk-link-heading"
                        >Apple MacBook Air 13&quot; MQD32LL/A 128GB (Silver)</a
                      >
                    </h3>
                    <ul
                      class="uk-list uk-text-small tm-product-card-properties"
              ...
              <article class="tm-product-card">
                ...
                <div class="tm-product-card-body">
                  <div class="tm-product-card-info">
                    ...
                    <h3 class="tm-product-card-title">
                      <a class="uk-link-heading"
                        >Lenovo Yoga 720-13IKB 80X60059RK (Silver)</a
                      >
                    </h3>
                    <ul
                      class="uk-list uk-text-small tm-product-card-properties"
