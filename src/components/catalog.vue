                                ...
                                <aside class="uk-width-1-4 uk-visible@m tm-aside-column">
                                    <nav class="uk-card uk-card-default uk-card-body uk-card-small" uk-sticky="bottom: true; offset: 90">
                                        <ul class="uk-nav uk-nav-default" uk-scrollspy-nav="closest: li; scroll: true; offset: 90">
                                            <li><a href="#laptops-tablets">Laptops &amp; Tablets</a></li>
                                            <li><a href="#phones-gadgets">Phones &amp; Gadgets</a></li>
                                            <li><a href="#tv-video">TV &amp; Video</a></li>
                                            <li><a href="#games-entertainment">Games &amp; Entertainment</a></li>
                                    ...
                                    <div class="uk-grid-medium uk-child-width-1-1" uk-grid>
                                            ...
                                            <div class="uk-card uk-card-default uk-card-small tm-ignore-container">
                                                <header class="uk-card-header">
                                                    <div class="uk-grid-small uk-flex-middle" uk-grid>
                                                        <a href="category.html"><img src="images/catalog/computers.svg" alt="Laptops &amp; Tablets" width="50" height="50"></a>
                                                        <div class="uk-width-expand">
                                                            <h2 class="uk-h4 uk-margin-remove"><a class="uk-link-heading" href="category.html">Laptops &amp; Tablets</a></h2>
                                        ...
                                        <section id="phones-gadgets">
                                            <div class="uk-card uk-card-default uk-card-small tm-ignore-container">
                                                <header class="uk-card-header">
                                                    <div class="uk-grid-small uk-flex-middle" uk-grid>
                                                        <a href="category.html"><img src="images/catalog/phones.svg" alt="Phones &amp; Gadgets" width="50" height="50"></a>
                                                        <div class="uk-width-expand">
                                                            <h2 class="uk-h4 uk-margin-remove"><a class="uk-link-heading" href="category.html">Phones &amp; Gadgets</a></h2>
                                        ...
                                        <section id="tv-video">
                                            <div class="uk-card uk-card-default uk-card-small tm-ignore-container">
                                                <header class="uk-card-header">
                                                    <div class="uk-grid-small uk-flex-middle" uk-grid>
                                                        <a href="category.html"><img src="images/catalog/tv.svg" alt="TV &amp; Video" width="50" height="50"></a>
                                                        <div class="uk-width-expand">
                                                            <h2 class="uk-h4 uk-margin-remove"><a class="uk-link-heading" href="category.html">TV &amp; Video</a></h2>
                                        ...
                                        <section id="games-entertainment">
                                            <div class="uk-card uk-card-default uk-card-small tm-ignore-container">
                                                <header class="uk-card-header">
                                                    <div class="uk-grid-small uk-flex-middle" uk-grid>
                                                        <a href="category.html"><img src="images/catalog/games.svg" alt="Games &amp; Entertainment" width="50" height="50"></a>
                                                        <div class="uk-width-expand">
                                                            <h2 class="uk-h4 uk-margin-remove"><a class="uk-link-heading" href="category.html">Games &amp; Entertainment</a></h2>
                                        ...
                                        <section id="photo">
                                            <div class="uk-card uk-card-default uk-card-small tm-ignore-container">
                                                <header class="uk-card-header">
                                                    <div class="uk-grid-small uk-flex-middle" uk-grid>
                                                        <a href="category.html"><img src="images/catalog/photo.svg" alt="Photo" width="50" height="50"></a>
                                                        <div class="uk-width-expand">
                                                            <h2 class="uk-h4 uk-margin-remove"><a class="uk-link-heading" href="category.html">Photo</a></h2>
