                                                                ...
                                                                <div class="uk-width-expand">
                                                                    <div class="tm-product-card-body uk-padding-remove uk-height-1-1">
                                                                        <div class="tm-product-card-info">
                                                                            <div class="uk-text-meta uk-margin-xsmall-bottom">Laptop</div><a class="tm-product-card-title" href="product.html">Apple MacBook Pro 15&quot; Touch Bar MPTU2LL/A 256GB (Silver)</a>
                                                                        </div>
                                                                        <div class="tm-product-card-shop">
                                                                            ...
                                                                            <div class="tm-product-card-add">
                                                                                <button class="uk-button uk-button-primary tm-product-card-add-button tm-shine js-add-to-cart"><span class="tm-product-add-button-icon" uk-icon="cart"></span><span class="tm-product-card-add-button-text">add to cart</span>
                                              </button>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                        ...
                                                        <div>
                                                            <div class="uk-grid-small uk-height-1-1" uk-grid="uk-grid">
                                                                ...
                                                                <div class="uk-width-expand">
                                                                    <div class="tm-product-card-body uk-padding-remove uk-height-1-1">
                                                                        <div class="tm-product-card-info">
                                                                            <div class="uk-text-meta uk-margin-xsmall-bottom">Laptop</div><a class="tm-product-card-title" href="product.html">Apple MacBook 12&quot; MNYN2LL/A 512GB (Rose Gold)</a>
                                                                        </div>
                                                                        <div class="tm-product-card-shop">
                                                                            <div class="tm-product-card-prices">
                                                        ...
                                                        <div>
                                                            <div class="uk-grid-small uk-height-1-1" uk-grid="uk-grid">
                                                                <div class="uk-width-1-3">
                                                                    <div class="tm-ratio tm-ratio-4-3">
                                                                        <a class="tm-media-box" href="product.html">
                                                                            <figure class="tm-media-box-wrap"><img src="images/products/6/6-small.jpg" alt="Apple MacBook Air 13&quot; MQD32LL/A 128GB (Silver)" />
                                                                            </figure>
                                                                        </a>
                                                                    </div>
                                                                </div>
                                                                <div class="uk-width-expand">
                                                                    <div class="tm-product-card-body uk-padding-remove uk-height-1-1">
                                                                        <div class="tm-product-card-info">
                                                                            <div class="uk-text-meta uk-margin-xsmall-bottom">Laptop</div><a class="tm-product-card-title" href="product.html">Apple MacBook Air 13&quot; MQD32LL/A 128GB (Silver)</a>
                                                                        </div>
                                                                        <div class="tm-product-card-shop">
                                                                            <div class="tm-product-card-prices">
