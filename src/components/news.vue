                                            ...
                                            <li>
                                                <article class="uk-article">
                                                    <div class="uk-article-body">
                                                        ...
                                                        <div>
                                                            <h3><a class="uk-link-heading" href="article.html">Highlights from WWDC</a></h3>
                                                        </div>
                                            ...
                                            <li>
                                                <article class="uk-article">
                                                    <div class="uk-article-body">
                                                        ...
                                                        <div>
                                                            <h3><a class="uk-link-heading" href="article.html">Apple introduces macOS Mojave</a></h3>
                                                        </div>
                                                        <div class="uk-margin-small-top">
                                                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Proin sodales eget ipsum id aliquam. Nam consectetur interdum nibh eget sodales. Cras volutpat efficitur ornare.</p>
                                                        </div>
                                            ...
                                            <li>
                                                <article class="uk-article">
                                                    <div class="uk-article-body">
                                                        ...
                                                        <div>
                                                            <h3><a class="uk-link-heading" href="article.html">iOS 11.4 brings stereo pairs and multi-room audio with AirPlay 2</a></h3>
                                                        </div>
                                                        <div class="uk-margin-small-top">
                                                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Proin sodales eget ipsum id aliquam. Nam consectetur interdum nibh eget sodales. Cras volutpat efficitur ornare.</p>
                                                        </div>
