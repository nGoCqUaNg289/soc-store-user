                                            ...
                                            <fieldset class="uk-fieldset">
                                                ...
                                                <ul class="uk-list uk-margin-remove">
                                                    <li>
                                                        ...
                                                        <label for="notification-1"><span>Weekly Newsletter</span></label>
                                                    </li>
                                                    <li>
                                                        <input class="tm-checkbox" id="notification-2" type="checkbox" name="notification" value="1" checked>
                                                        <label for="notification-2"><span>New Product Announcements</span></label>
                                                    </li>
                                                    <li>
                                                        <input class="tm-checkbox" id="notification-3" type="checkbox" name="notification" value="1" checked>
                                                        <label for="notification-3"><span>Product Specials</span></label>
                                                    </li>
                                                </ul>
                                            </fieldset>
                                        </div>
